...
return {
  ...
  opts = {
    ...
    task_list = {
      direction = 'right',
      keymaps = {
        ['k'] = { "<CMD>lua require('overseer.task_list.sidebar').get():jump(-1)<CR>", desc = 'Jump to previous task' },
        ['j'] = { "<CMD>lua require('overseer.task_list.sidebar').get():jump(1)<CR>", desc = 'Jump to next task' },
